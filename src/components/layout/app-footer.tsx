    ...
    return (
        <footer className="w-full bg-black text-white">
            <div className="container mx-auto flex flex-col items-center justify-center text-center gap-4 py-12 px-4">
                ...
                <a href="https://t.me/Javlonbekh" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-medium text-white hover:underline">
                    <Send className="h-4 w-4" />
                    Murojat va takliflar uchun
                </a>
                <div className="border-t border-white/20 mt-8 w-full">
