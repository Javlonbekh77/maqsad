...
export default function AppFooter() {
    return (
        <footer className="mt-auto w-full py-12 bg-black text-white">
            <div className="container mx-auto flex flex-col items-center justify-center text-center gap-4">
             ...
             <div className="border-t border-white/20 py-4 mt-8">
                <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center text-xs text-white/60 gap-2">
