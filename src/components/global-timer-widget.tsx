...
export default function GlobalTimerWidget() {
  ...
  return (
    <>
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 md:bottom-6 md:right-6 md:left-auto md:translate-x-0 md:w-80 w-[calc(100%-32px)] z-40">
        <div className="bg-white/80 backdrop-blur-sm border rounded-xl shadow-lg p-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={handleManualComplete} aria-label="Complete" className="inline-flex items-center justify-center h-9 w-9 rounded-md border">
              <Check />
            </button>
      ...
      {/* Confirmation dialog removed: timer now auto-completes on finish in TimerContext. */}
    </>
  );
}
